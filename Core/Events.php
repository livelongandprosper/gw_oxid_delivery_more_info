<?php
	namespace gw\gw_oxid_delivery_more_info\Core;
	...
	class Events {
		...
		public static function onActivate() {
			try {
				self::add_db_field('oxdeliveryset', 'gw_delivery_mandatory_userinfo_fields', "TEXT DEFAULT '' NOT NULL COMMENT 'mandatory oxuser or oxaddress fields e.g. oxfon'");
		...
		public static function onDeactivate() {
			...
			DatabaseProvider::getDb()->execute("DELETE FROM oxtplblocks WHERE oxshopid='".$config->getShopId()."' AND oxmodule='gw_oxid_delivery_more_info';");
			// DatabaseProvider::getDb()->execute("ALTER TABLE oxvoucherseries DROP INDEX gw_oxid_delivery_more_info;");
